...
class GhostPlanner:
    ...
    def _call_api_fallback(self, messages: list) -> str:
        ...
        # Strictly Offline-Only: No external API calls allowed.
        raise RuntimeError(
            "Ollama is offline. External API fallback (Anthropic/OpenAI) is disabled "
            "to enforce 'Offline-only' and 'Zero Telemetry' compliance."
        )
