...
function App() {
  return (
    <main className="min-h-screen bg-void text-ghost selection:bg-cyan/30 selection:text-cyan overflow-hidden">
       ...
       <footer className="py-12 border-t border-white/5 bg-plate/30 text-center text-ghost/20 font-mono text-xs tracking-widest uppercase">
          Ghost Kernel v6.0 :: Sovereign Infrastructure
       </footer>
    </main>
  )
}
